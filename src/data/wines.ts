...
Chai vang này đặc biệt phù hợp dùng trong bữa ăn hằng ngày, tiệc gia đình, liên hoan, nhà hàng phổ thông hoặc làm table wine.`,
  ...
  },
  {
    ...
    grapes: "Cannonau",
    price: "520,000₫",
    description: "Rượu vang Roberto Riga Rosso là sản phẩm tiêu biểu đến từ vùng Sardegna, một hòn đảo lớn nằm ở phía Tây nước Ý, giữa Địa Trung Hải. Sardegna từ lâu đã được biết đến là một trong những vùng trồng nho đặc trưng và giàu bản sắc của Ý.",
    story: `Sardegna có điều kiện tự nhiên lý tưởng cho việc sản xuất rượu vang: khí hậu ấm áp, khô ráo, nhiều nắng, cùng đất đỏ pha sét giàu khoáng chất. Giống nho chủ đạo được sử dụng để làm nên Roberto Riga Rosso là Cannonau – giống nho bản địa nổi tiếng nhất của Sardegna (được xem là họ hàng gần của Grenache). Cannonau mang đến cho rượu hương vị trái cây chín đậm đà, tannin rõ ràng nhưng không thô, cùng độ axit cân bằng, tạo nên phong cách vang đặc trưng của vùng đảo Địa Trung Hải.
...
Nhờ sự kết hợp giữa giống nho Cannonau đặc trưng và điều kiện tự nhiên độc đáo của Sardegna, Roberto Riga Rosso mang phong cách vang Ý truyền thống, mạnh mẽ nhưng dễ tiếp cận, phù hợp dùng hằng ngày hoặc trong các bữa tiệc thân mật.`,
...
Rượu được phối trộn từ ba giống nho đặc biệt: Carignan từ những cây nho cổ thụ trên 80 tuổi, Syrah mang đến cấu trúc và gia vị, Malbec góp phần tạo độ sâu và mềm mại. Tất cả được canh tác theo phương pháp sinh học động học, không sử dụng hóa chất.
...
Trong ly, 958 Santero Asti thể hiện màu vàng rơm ánh xanh tươi sáng, bọt mịn sống động. Hương thơm thanh nhã của hoa cơm cháy, đào, nho Moscato tươi và mật ong. Trên vòm miệng, rượu ngọt dịu, tươi mát, cân bằng hoàn hảo giữa độ ngọt và độ chua.`,
    ...
    flavorNotes: ["elderflower", "peach", "moscato", "honey"],
    characteristics: {
      sweetness: 7,
      body: 3,
      tannin: 0,
