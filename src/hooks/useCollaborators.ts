...
// Note: wallet balance is updated automatically via database trigger
...
// Note: wallet balance is updated automatically via database trigger when status changes to approved
