...
export const usePendingRequestCounts = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const [birthdayResult, personalizedResult, profileUpdatesResult, withdrawalsResult, collaboratorOrdersResult, passwordRequestsResult, applicationsResult, contactMessagesResult, blogResult] = await Promise.all([
        supabase
      ...
      return {
        ...
        blogPending: blogResult.count ?? 0
      };
    },
