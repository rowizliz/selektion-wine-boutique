    ...
    <>
      ...
      <main className="min-h-screen bg-background p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          {/* Stats */}
          <section className="grid grid-cols-1 md:grid-cols-4 gap-4" aria-label="Thống kê">
            <Card>
                ...
                {isLoading ? (
                  ...
                  <div className="text-center py-12">
                    <p className="text-muted-foreground">
                      Database hiện đang trống. Bạn có thể import nhanh từ file tĩnh hoặc thêm chai mới.
                    </p>
                    <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
                      <Button asChild variant="outline">
                        <Link to="/admin/import-wines">Import từ file tĩnh</Link>
                      </Button>
                      <Button onClick={handleCreate}>
                        <Plus className="h-4 w-4 mr-2" />
                        Thêm rượu
